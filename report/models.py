...
from aulas_limpias.settings import CENTROS
...
#   def _make_random_key(self, key_len): Cuando usamos longitudes variables
...
class Report(RandomPrimaryIdModel):
    # Internas
    ...
    #Opcionales
    surname_victim = models.CharField(max_length=50, blank=True, default='')
    ...
    img_files = models.ImageField(upload_to='', blank=True)
    aud_files = models.FileField(upload_to='', blank=True)
